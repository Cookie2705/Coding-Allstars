...
files_from_folder = r"C:\Users\AfsinAnil\Desktop\Coding Allstars"
...
for file in os.listdir(directory):
    ...
    if filename.endswith(extension_file):
        with open(os.path.join(files_from_folder, filename), encoding='utf-8') as html:
            ...
            for meta in soup.findAll('meta',{'name':'description'}):
                try:
                    ...
                    pass
            for h1 in soup.findAll('h1',{'itemprop':'name'},class_='den_aticol'):
        ...
        if use_translate_folder:
            try:
                with open(os.path.join(files_from_folder+r'\translated',new_filename), encoding='utf-8') as new_html:
